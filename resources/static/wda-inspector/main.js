(function e(t, n, r) {
    ...
    1: [function (require, module, exports) {
        ...
        module.exports = Info;
    }, {"./tpl/error.html": 2, "./tpl/info.html": 3, "mustache": 15}],
    ...
    3: [function (require, module, exports) {
        module.exports = '<div class="wda_info_content">' +
            ...
            '<strong>Class</strong> XCUIElementType{{info.type}} <br>' +
    ...
    }, {"./tpl/error.html": 5, "./tpl/highlight.html": 6, "./tpl/lockOverlay.html": 7, "mustache": 15}],
    5: [function (require, module, exports) {
        module.exports = '<div class="wda_screen_error">{{message}}</div>';
    ...
    10: [function (require, module, exports) {
        ...
        module.exports = Tree;
    }, {"./tpl/error.html": 11, "./tpl/item.html": 12, "./tpl/lockOverlay.html": 13, "mustache": 15}],
    11: [function (require, module, exports) {
        module.exports = '<div class="tree_error">{{message}}</div>';

    }, {}],
    12: [function (require, module, exports) {
        module.exports = '{{#hasChildren}}' +
            '<a id="{{num}}" href="#"><i class="glyphicon glyphicon-minus element-with-children"></i></a>' +
            '{{/hasChildren}}' +
            '<span class="label label-default el-type" data-rect="{{rectStr}}">' +
            '<strong>XCUIElementType{{type}}</strong>' +
            '</span>' +
            '{{#rawIdentifier}}' +
    ...
    }, {"./Info/Info.js": 1, "./Screen/Screen.js": 4, "./Search/Search.js": 8, "./Tree/Tree.js": 10}],
