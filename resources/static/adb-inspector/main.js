(function e(t, n, r) {
    ...
    5: [function (require, module, exports) {
        module.exports = '<div class="adb_screen_error">{{message}}</div>';
    ...
    12: [function (require, module, exports) {
        module.exports = '{{#hasChildren}}' +
            ...
            '{{/hasChildren}}' +
            '<span class="label label-default el-type" data-bound="{{bounds}}">' +
            '<strong>{{class}}</strong>' +
            '</span>' +
            '{{#text}}' +
            '<span class="el-id label label-success">{{text}}</span>' +
            '{{/text}}' +
            '<span class="el-label">{{content-desc}}</span>'
    }, {}],
